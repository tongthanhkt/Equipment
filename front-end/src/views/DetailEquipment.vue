<template>
  <div>
        ...
        <div class="p-1 w-auto h-auto mx-auto bg-gray-50 shalow-lg rounded-xl">
          ...
          <div class="p-1 m-4 grid grid-rows-1 grid-flow-col">
            <div>
              ...
              <button
                class="sm:h-auto sm:w-auto px-4 py-1 my-4 mx-20 text-center focus:outline-none transition-colors rounded-md border-b border-gray-300 bg-gray-200 hover:bg-gray-300 text-gray-700"
              >
          ...
          <div class="grid grid-flow-col grid-rows-1">
            <div class="p-2 flex justify-start w-auto">
              <span class="flex justify-start">
                <div
                  class="px-1 py-2 m-2 text-base grid grid-rows-1 grid-flow-col rounded-md w-fit border-2 border-blue-400 focus:border-blue-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500"
                >
                  <fa
              ...
              >
                ...
                <tbody>
                      ...
                      <div class="flex justify-around w-auto">
                        <span class="flex justify-center">
                          <button
                            ...
                            v-on:click.stop="
                              isEditTakeOverShow = !isEditTakeOverShow
                            "
                          >
                  ...
                  >
                    ...
                    <td>
                      <div
                        class="flex justify-around w-auto"
                        @click.prevent.self
                      >
                        <span class="flex justify-center">
                          <button
    ...
    <AddTakeOver
      ...
      v-on="{
        changeAddTakeOverShow: handleAddTakeOverShow,
        changeEditTakeOverShow: handleEditTakeOverShow,
      }"
    />
    <EditTakeOver
      v-if="isEditTakeOverShow"
