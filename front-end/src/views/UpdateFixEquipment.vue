      ...
      <div class="pl-3 text-sm grid grid-cols-3 grid-flow-row mt-2 mb-3.5">
        ...
        <div>
          <v-select
            ...
            :options="options" v-model="fixer" :get-option-label="(option) => option.username"
    ...
    <div class="bg-indigo-100 w-full border-t border-gray-300">
      ...
      <div class="flex flex-row gap">
        <button
          ...
          @click="updateFixEquipmentRecord">
...
export default class UpdateFixEquipment extends Vue {
  ...
  async updateFixEquipmentRecord() {
    if (this.fixer == null) {
      alert("Hãy chọn người sửa thiết bị!");
    ...
    // }
      ...
      const data = {
        ...
        fixing_time: this.editDate.getTime(),
        fixer: this.fixer?.username,
